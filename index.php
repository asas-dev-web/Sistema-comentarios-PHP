...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="">Sistema de comentários</a>
    ...
    <div class="modal fade" id="replyCommentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Responder ao comentário</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="replyCommentForm">
                        ...
                        <p>Respondendo a:<span id="replyTo"></span></p>
                        <div class="form-group">
                            <label for="replier">Seu nome</label>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Escreva um comentário</h4>
                        <form action="./endpoint/add-comment.php" method="POST">
                            <div class="form-group">
                                <label for="commentator">Nome</label>
                                <input type="text" class="form-control" name="commentator" id="commentator" required>
                            </div>
                            <div class="form-group">
                                <label for="comment">Escrever comentário</label>
                ...
                <div class="d-flex justify-content-between mb-4">
                    <button class="btn btn-outline-primary view-comment-button" onclick="viewAllComment()">Ver todos os comentários</button>
                    <button class="btn btn-outline-secondary hide-comment-button" onclick="hideAllComment()" style="display:none;">Ocultar todos os comentários</button>
                </div>
                        ...
                        <div class="card mb-3 comment" style="display:none;">
                            <div class="card-body">
                                ...
                                <div class="comment-option mt-3">
                                    <button class="btn btn-sm btn-outline-primary mr-2" onclick="replyComment(<?= $commentID ?>)">Responder</button>
                                    <button class="btn btn-sm btn-outline-secondary mr-2" onclick="updateComment(<?= $commentID ?>)">Editar</button>
                                    <button class="btn btn-sm btn-outline-danger mr-2" onclick="deleteComment(<?= $commentID ?>)">Deletar</button>
                                    <label class="like">
                                        <input type="checkbox">
                                ...
                                ?>
                                    ...
                                    <div class="reply mt-3">
                                        ...
                                        <div class="comment-option mt-2">
                                            <button class="btn btn-sm btn-outline-secondary mr-2" onclick="updateReply(<?= $replyID ?>)">Editar</button>
                                            <button class="btn btn-sm btn-outline-danger mr-2" onclick="deleteReply(<?= $replyID ?>)">Deletar</button>
                                            <label class="like">
                                                <input type="checkbox">
                                                <svg id="Glyph" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <path d="M29.845,17.099l-2.489,8.725C26.989,27.105,25.804,28,24.473,28H11c-0.553,0-1-0.448-1-1V13  c0-0.215,0.069-0.425,0.198-0.597l5.392-7.24C16.188,4.414,17.05,4,17.974,4C19.643,4,21,5.357,21,7.026V12h5.002  c1.265,0,2.427,0.579,3.188,1.589C29.954,14.601,30.192,15.88,29.845,17.099z" id="XMLID_254_"></path>
